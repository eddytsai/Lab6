...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transData[0].name = "bike";
        transData[1].name = "motor";
        ...
        cubeeData[1].photo = R.drawable.cubee1 ;
        cubeeData[2].photo = R.drawable.cubee1 ;
        cubeeData[3].photo = R.drawable.cubee1 ;
        cubeeData[4].photo = R.drawable.cubee1 ;
        cubeeData[5].photo = R.drawable.cubee1 ;
        cubeeData[6].photo = R.drawable.cubee1 ;
        cubeeData[7].photo = R.drawable.cubee1 ;
        cubeeData[8].photo = R.drawable.cubee1 ;
        cubeeData[9].photo = R.drawable.cubee1 ;
        ...
        String[] messageData = new String[]{"訊息1","訊息2","訊息3","訊息4","訊息5"};
